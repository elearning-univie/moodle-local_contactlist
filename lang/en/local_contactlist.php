...
$string['changegloballink'] = '&nbsp;&nbsp;&nbsp;<a href="{$a->here}" style=" color: #fc0f03;"> Change your moodle-wide contactlist visibility setting HERE.</a>';
$string['customcoursefieldlabel'] = 'Course navigation contactlist visibility';
$string['globaldefault'] = 'Global ({$a->globalsetting})';
$string['globaldefaultsetting'] = 'Use moodle-wide contactlist visibility setting (default)';
$string['gnly'] = 'Your contactlist visibility setting in this course (visible) is different from your moodle-wide setting (not visible). You can change the visibility for ALL courses in the <a href="{$a->here}" style=" color: #fc0f03;"> privacy settings of your user profile</a>.';
