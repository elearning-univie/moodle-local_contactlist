...
$string['changegloballink'] = '<a href="{$a->here}"> Change your moodle-wide contactlist visibility setting HERE.</a>';
$string['customcoursefieldlabel'] = 'Course navigation contactlist visibility';
$string['globaldefaultsetting'] = 'Use moodle-wide contactlist visibility setting (default).<br><a href="{$a->here}"> Change your moodle-wide contactlist visibility setting HERE.</a> ';
